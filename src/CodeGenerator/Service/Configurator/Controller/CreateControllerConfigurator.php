...
class CreateControllerConfigurator extends BaseControllerConfigurator implements IControllerConfigurator
{
    ...
    public function createMethodConfiguration(Context $context): MethodConfiguration
    {
        ...
        $methodBuilder
            ->addArgument(new MethodArgumentConfiguration(self::ARGUMENT_NAME, $entityClassName . 'CreateRequest'))
            ->addAttribute(MethodAttributeConfigurationFactory::createCreateRouteAttribute($context->entityFQCN));
