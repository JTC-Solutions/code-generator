...
class ContextProvider
{
     ...
     * @param class-string|null $serviceFullyQualifiedClassName Holds the FQCN of a Service generated by ServiceGenerator, to be used by controller generators (e.g., Create/Update). Set dynamically during generation.
     */
    ...
    /**
     * Calculates the absolute filesystem path for a Service based on the entity FQCN and configured templates.
     *
     * @param class-string $classFullyQualifiedClassName The FQCN of the related entity.
     *
     * @return string The absolute path to the directory where the Service should be placed
     * @throws Exception If namespace/path conversion or variable replacement fails.
     */
    public function getServicePath(string $classFullyQualifiedClassName): string
    {
    ...
    /**
     * Calculates the target namespace for a Service based on the entity FQCN and configured template.
     *
     * @param class-string $classFullyQualifiedClassName The FQCN of the related entity.
     * @return string The calculated Service namespace.
     * @throws Exception If variable replacement fails.
     */
    public function getServiceNamespace(string $classFullyQualifiedClassName): string
    {
        return $this->replaceVariables($this->serviceNamespaceTemplate, $classFullyQualifiedClassName);
    }
