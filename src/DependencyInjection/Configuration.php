                        ...
                        ->arrayNode('namespace')
                            ->children()
                                ->scalarNode('controllerNamespaceTemplate')
                                    ...
                                    ->example('App\{domain}\App\Api\{entity}}')
                                ...
                                ->scalarNode('dtoNamespaceTemplate')
                                    ...
                                    ->example('App\{domain}\Domain\Dto\{entity}')
                                ...
                                ->end()
                                ->scalarNode('repositoryNamespaceTemplate')
                                    ->info('Template for Repository namespaces. Use {domain} or {entity} for Domain and Entity.')
                                    ->example('App\{domain}\Infrastructure')
                                    ->defaultValue('App\{domain}\Infrastructure')
                                ->end()
                            ->end()
                        ->end() // namespace
                        ->arrayNode('project')
